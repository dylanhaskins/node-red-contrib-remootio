module.exports = function(RED) {
    ...
    function RemootioCredentialsNode(config){
        ...
        garagedoor1 = new RemootioDevice(
            this.credentials.ipaddress, //Device IP address
            this.credentials.apisecretkey, //API Secret Key
            this.credentials.apiauthkey, //API Auth Key
            );
    ...
    function RemootioStatusNode(config) {
        ...
        var credentials = RED.nodes.getCredentials(this.remootio);
        var node = this;
        node.status({});
        ...
        //                     break;
        //                 case "closed" :
        //                     this.status({fill:"green",shape:"ring",text:"closed"});
        //                     break;
        //                 default : 
